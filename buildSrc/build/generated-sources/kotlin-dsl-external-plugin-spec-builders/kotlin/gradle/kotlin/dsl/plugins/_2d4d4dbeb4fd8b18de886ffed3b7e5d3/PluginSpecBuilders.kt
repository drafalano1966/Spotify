...
package gradle.kotlin.dsl.plugins._2d4d4dbeb4fd8b18de886ffed3b7e5d3
...
/**
 * The `com.jakewharton` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComJakewhartonPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.jakewharton`.
 */
internal
val `ComPluginGroup`.`jakewharton`: `ComJakewhartonPluginGroup`
    get() = `ComJakewhartonPluginGroup`(plugins)


/**
 * The `com.jakewharton.mosaic` plugin implemented by [com.jakewharton.mosaic.gradle.MosaicPlugin].
 */
internal
val `ComJakewhartonPluginGroup`.`mosaic`: PluginDependencySpec
    get() = plugins.id("com.jakewharton.mosaic")
...
/**
 * The `de.comahe` plugin group.
 */
@org.gradle.api.Generated
internal
class `DeComahePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `de.comahe`.
 */
internal
val `DePluginGroup`.`comahe`: `DeComahePluginGroup`
    get() = `DeComahePluginGroup`(plugins)


/**
 * The `de.comahe.i18n4k` plugin implemented by [de.comahe.i18n4k.gradle.plugin.I18n4kPlugin].
 */
internal
val `DeComahePluginGroup`.`i18n4k`: PluginDependencySpec
    get() = plugins.id("de.comahe.i18n4k")
